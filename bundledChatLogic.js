...
},{"./transports/index.js":12,"./util.js":18,"@socket.io/component-emitter":5,"debug":19,"engine.io-parser":25,"parseqs":28,"parseuri":29}],11:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./util.js":18,"@socket.io/component-emitter":5,"debug":19,"engine.io-parser":25}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../globalThis.js":8,"../util.js":18,"./polling.js":14,"./xmlhttprequest.js":17,"@socket.io/component-emitter":5,"debug":19}],14:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"../transport.js":11,"debug":19,"engine.io-parser":25,"parseqs":28,"yeast":41}],15:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"../transport.js":11,"../util.js":18,"./websocket-constructor.js":15,"buffer":2,"debug":19,"engine.io-parser":25,"parseqs":28,"yeast":41}],17:[function(require,module,exports){
"use strict";
...
},{"./common":20,"_process":4}],20:[function(require,module,exports){
...
},{"./commons.js":22,"base64-arraybuffer":7}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const commons_js_1 = require("./commons.js");
...
},{"./on.js":32,"./socket.js":33,"@socket.io/component-emitter":5,"backo2":6,"debug":35,"engine.io-client":9,"socket.io-parser":39}],32:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.on = void 0;
...
},{"./common":36,"_process":4,"dup":19}],36:[function(require,module,exports){
...
},{"./binary.js":38,"./is-binary.js":40,"@socket.io/component-emitter":5,"debug":35}],40:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const socket = (0, socket_io_client_1.io)(); //: Socket<ServerToClientEvents, ClientToServerEvents> 
let username;
//Used with method addToChat()
var AddToChatTypes;
(function (AddToChatTypes) {
    AddToChatTypes["me"] = "meUser";
    AddToChatTypes["other"] = "otherUser";
})(AddToChatTypes || (AddToChatTypes = {}));
//Set key binding
(0, jquery_1.default)(function () {
    (0, jquery_1.default)("#message").on("keyup", function (event) {
        if (event.which == 13) {
            event.preventDefault();
            (0, jquery_1.default)("#sendMessage").trigger("click");
        }
    });
    (0, jquery_1.default)("#chatBox").on('scroll', (e) => {
        showNotificationDot(true);
    });
    (0, jquery_1.default)("#sendMessage").on('click', (e) => {
        sendMessage();
    });
});
...
function showNotificationDot(onlyHide = false) {
    let isAtBottom = nearBottomScrollbar(document.getElementById('chatBox'));
    if (isAtBottom)
        (0, jquery_1.default)('.dot').hide();
    else if (!onlyHide)
        (0, jquery_1.default)('.dot').show();
}
function nearBottomScrollbar(ele) {
    ...
    if (ht == 0)
        return true;
    if (rangeValue < st + 10 && rangeValue > st - 10) {
        return true;
    }
    else {
        return false;
...
},{"jquery":27,"socket.io-client":30}]},{},[42]);
